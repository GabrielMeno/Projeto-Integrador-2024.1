                        ...
                        <div className="flex flex-col items-center gap-[38px]">
                            ...
                            <div className="flex w-[30%] justify-between gap-5 md:w-full">
                                <a href="https://www.youtube.com/embed/bv8Fxk@sz71" target="_blank">
                                    <Button shape="round" className="min-w-[156px] font-semibold sm:px-5"> Cancelar </Button>
                                </a>
                                <a href="https://www.youtube.com/embed/bv8Fxk@sz71" target="_blank"> <Button shape="round" className="min-w-[156px] font-semibold sm: px-5"> Salvar
                                </Button>
                                </a>
                            </div>
                        </div>
